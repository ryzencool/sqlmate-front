...
export default function DBSql() {
    ...
    const handleSearch = (e) => {
        ...
        setSearchParam({
            // @ts-expect-error TS(2339) FIXME: Property 'id' does not exist on type '{}'.
            projectId: project.id,
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ projectId: any; condition: any... Remove this comment to see the full error message
            condition: value
        })
    }
    ...
    return <div className={"w-full flex flex-col gap-5 "}>
                    ...
                    projectSqlsQuery.data.data.data.map(it => {
                        return (
                            <div className={'flex flex-col gap-3 border-b pb-4'} key={it.id}>
                                ...
                                {/* @ts-expect-error TS(2741) FIXME: Property 'msg' is missing in type '{ open: boolean... Remove this comment to see the full error message */}
        ...
        <div>
            ...
            {/* @ts-expect-error TS(2741) FIXME: Property 'value' is missing in type '{ closeDialog... Remove this comment to see the full error message */}
